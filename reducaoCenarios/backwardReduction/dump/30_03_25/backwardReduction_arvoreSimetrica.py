...
print(df_vazoes)
df_vazoes.to_csv("BKSimetrico\\cenarios.csv", index=False)
...
print(df_arvore)
df_arvore.to_csv("BKSimetrico\\arvore_estudo.csv", index=False)
...
df_arvore.to_csv("BKSimetrico\\arvore.csv", index=False)
...
df_result.to_csv("BKSimetrico\\estatisticas_Arv_red.csv", index=False)



printaArvore("BKSimetrico\\Arvore_reduzida", df_arvore)
print(df_arvore)