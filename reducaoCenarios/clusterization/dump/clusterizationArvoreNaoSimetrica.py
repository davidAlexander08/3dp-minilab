...
print(df_vazoes)
df_vazoes.to_csv("ClusterAssimetrico\\vazoes_estudo.csv", index=False)
...
print(df_arvore)
df_arvore.to_csv("ClusterAssimetrico\\arvore_estudo.csv", index=False)
...
printaArvore("ClusterAssimetrico\\Arvore_reduzida", df_arvore)
print(df_arvore)
print(df_vazoes)

df_arvore.loc[df_arvore["NO"] == 1, "NO_PAI"] = 0

df_arvore.to_csv("ClusterAssimetrico\\arvore.csv", index=False)
df_vazoes.to_csv("ClusterAssimetrico\\cenarios.csv", index=False)
