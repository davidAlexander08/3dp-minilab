...
for caso in mapa_casos:
    ...
    for analise in analises:
        ...
        print(f" Caso {mapa_casos[caso]} Est {analise[1]} R²: {r_squared:.2f}")
            # Print the results
            #print("ORIGINAL: ")
    ...
    fig.write_html(camino_caso_orig+pasta_arvores+f"\\{mapa_casos[caso]}_correlacaoEspacialArvores.html")
        # Print R² value
